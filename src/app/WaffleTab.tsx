...
/** The Waffle Shop tab: the guided, read-only example for the selected release, full width. */
export default function WaffleTab({ state, active }: { state: HistoryState; active: boolean }) {
